...
#### what did we do?
We implemented a Facebook application which encourages consumer engagement by running a questionnaire game which is tied to regular competitions and prize draws. It was important to leverage not only the social aspect offered by Facebook's platform but also the consumer data available.
...
#### how did we do it?
* We accomplished this through the use of HTML5 
* We built the app functionality using the .NET framework.
